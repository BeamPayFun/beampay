...
- **合约设计与不变量:** [beampay-contracts/CLAUDE.md](https://github.com/BeamPayFun/beampay-contracts/blob/main/CLAUDE.md)
- **商户接入:** 见 [`@beampay/sdk`](https://github.com/BeamPayFun/beampay-libs) 与 [`@beampay/checkout`](https://github.com/BeamPayFun/beampay-checkout)
